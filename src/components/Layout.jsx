...
function Layout() {
    ...
    <>
      <div id='layout' className='lg:my-36 w-full relative'>
        <div className='h-16 flex justify-center items-center lg:h-24 text-[#FD6F65]'>
          <marquee className="font-Poppins text-[4rem] lg:text-[10rem]" behavior="scroll" direction="left"
        ...
        <div className='h-16 flex mt-2 justify-center items-center lg:h-24 text-[#FD6F65]'>
          <marquee className="absolute top-8 font-Poppins text-[4rem] lg:text-[10rem]" behavior="scroll" direction="right"
            loop="infinite" scrollamount="12">
            Web Development, Landing Pages, and Scraping Solutions. Custom designs, seamless builds, and tailored results!
          </marquee>
        </div>
  ...
  <h1 className='text-4xl font-semibold leading-loose font-Poppins uppercase text-white lg:mb-12'>Expertise</h1>
  <div className='testimonial-box flex flex-col md:flex-row flex-wrap gap-12 font-Poppins text-[17px]'>
    ...
    <div className='border px-12 py-6 border-[#FD6F65] rounded-xl flex flex-col gap-4 md:w-[calc(50%-24px)]'>
      ...
      <h1 className='mt-6'>blakecabot- Fiverr</h1>
    </div>
    ...
    <div className='border px-12 py-6 border-[#FD6F65] rounded-xl flex flex-col gap-4 md:w-[calc(50%-24px)]'>
      ...
      <h1 className='mt-6'>fernandopena- Fiverr</h1>
    </div>
  </div>
</section>
        ...
        <section id='contact' className='my-24 flex justify-center'>
          <div className='contact text-white flex flex-col gap-2'>
            <h1 className='font-Poppins md:text-[150px] max-sm:text-center text-[40px]'>Let's talk</h1>
